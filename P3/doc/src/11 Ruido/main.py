...
def train(X,y,n_estimators=200, do_print=True, col_names = None):
    ...
    pop[0] = [0, 450 / 750, 0.15, 11 / 81, 0.9999999999, 800 / 1300, 400 / 1100, 10 / 21, 0, 0]
    pop[1] = [0., 0.6, 0.17916901, 0.80042335, 0.81231054, 0.64825269, 0.59849025, 0.66351866, 0.04397433, 0.01262955]
    pop[2] = [0, 450 / 750, 0.17558292, 0.31487049, 0.69838505, 0.42589426, 0.40468874, 0.52577021, 0.0854134,
              0.01384353]
    pop[3] = [0.20255799, 0.64062604, 0.53709839, 0.80093068, 0.67084769, 0.85401771, 0.24370506, 0.80628683,
              0.04472441, 0.01276028]
    ...
    def valida(x):
        ...
        lgbm, y_test_lgbm, v_acc = validacion_cruzada(clf, X, y, skf, cprint, msk, 2)
        h = np.average(v_acc)
        return h
