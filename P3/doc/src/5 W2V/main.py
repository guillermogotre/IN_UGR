...
def getW2V(data_x,data_x_tst,size=6,window=12):
    #size = 6
    #window = 12
    x_w2v = pd.concat([data_x,data_x_tst],axis=0)[CAT_KEYS].copy()
    ...
    X_train_w2v = data_x[CAT_KEYS].copy()
    X_test_w2v = data_x_tst[CAT_KEYS].copy()
